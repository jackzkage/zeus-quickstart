...
import com.sf.web.request.VersionCheckRequest;
import com.sf.web.response.VersionCheckResponse;
...
public class VersionController {
    ...
    public R<VersionCheckResponse> check(VersionCheckRequest request) {
        ...
        VersionCheckResponse response = VersionCheckResponse.builder()
                .updatedContent("1、修复BUG，提升优化体验")
                .isForceUpdate(false).findNewVersion("v3.0.1").build();
